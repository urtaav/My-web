        ...
        <div className='flex flex-col md:flex-row justify-between items-center'>
            ...
            <form 
             onSubmit={(e) => {
              ...
              const mailtoLink = `mailto:urieltapiaavalos@gmail.com?subject=Contact from ${name}&body=Name: ${name}%0AEmail: ${email}%0AMessage: ${message}`;
              ...
              <button className='bg-cyan-500 text-white px-3 py-2 rounded-lg'>Send Message</button>
            </form>
        </div>
      </div>
    </section>
